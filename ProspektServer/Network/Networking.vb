...
Namespace Network
    Public Module Networking
        ...
        Public Function getIndex(ByRef connection As NetConnection)
        ...
        Public Sub SendDataTo(ByVal index As Integer, ByRef Data As NetOutgoingMessage)
            If IsConnected(index) Then
                pServer.SendMessage(Data, ConnectedClients(index), NetDeliveryMethod.ReliableOrdered)
            End If
        End Sub

        Public Sub SendDataToAll(ByRef Data As NetOutgoingMessage)
            Dim i As Integer
        ...
        Public Sub SendDataToAllBut(ByVal index As Integer, ByRef Data As NetOutgoingMessage)
            Dim i As Integer
            For i = 1 To PlayerCount
                If Players.Logic.IsPlaying(i) Then
                    If i <> index Then
        ...
        Public Sub SendDataToAdmins(ByRef Data As NetOutgoingMessage)
            Dim i As Integer
        ...
        Public Sub HandleMessage()
            ...
            While Not IsNothing(im)
                ...
                index = getIndex(im.SenderConnection)
                    ...
                    Case NetIncomingMessageType.StatusChanged
                        ...
                        If status = NetConnectionStatus.Connected Then
                            ...
                            If I <> 0 Then
                                ...
                                Server.Writeline("Received connection from " & im.SenderConnection.RemoteUniqueIdentifier & ".")
                            End If
        ...
        Public Sub CloseSocket(ByVal index As Integer)
            If index > 0 Then
                Server.Writeline("Closed connection from " & ConnectedClients(index).RemoteUniqueIdentifier & ".")
                If Not IsNothing(Player(index)) Then
                    ...
                    End Select
                    Server.Writeline(Player(index).Name & " has left the game.")
